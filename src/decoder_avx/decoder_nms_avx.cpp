...
#define MANUAL_PREFETCH 1
    ...
    LDPCDecoder_NMS_AVX::LDPCDecoder_NMS_AVX(LDPC_Code code) : LDPCDecoderAVX(code)
    {
#if PETIT == 1
    ...
    LDPCDecoder_NMS_AVX::~LDPCDecoder_NMS_AVX()
    {
#if PETIT == 1
        delete p_vn_adr;
#endif
    ...
    void LDPCDecoder_NMS_AVX::setFactor(int _factor)
    {
        factor_1 = _factor;
        factor_2 = _factor;
    }

    void LDPCDecoder_NMS_AVX::decode(char Intrinsic_fix[], char Rprime_fix[], int nombre_iterations)
    {
        if (vSAT_POS_VAR == 127)
    ...
    bool LDPCDecoder_NMS_AVX::decode_8bits(char Intrinsic_fix[], char Rprime_fix[], int nombre_iterations)
    {
