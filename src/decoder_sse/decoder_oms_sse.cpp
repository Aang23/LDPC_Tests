...
#define MANUAL_PREFETCH 1
    ...
    LDPCDecoder_OMS_SSE::LDPCDecoder_OMS_SSE(LDPC_Code code) : LDPCDecoderSSE(code)
    {
        offset = -1;
#if PETIT == 1
        p_vn_adr = new __m128i *[code._M];
    ...
    LDPCDecoder_OMS_SSE::~LDPCDecoder_OMS_SSE()
    {
#if PETIT == 1
        delete p_vn_adr;
#endif
    ...
    void LDPCDecoder_OMS_SSE::setOffset(int _offset)
    {
        if (offset == -1)
        {
            offset = _offset;
    ...
    void LDPCDecoder_OMS_SSE::decode(char Intrinsic_fix[], char Rprime_fix[], int nombre_iterations)
    {
        if (vSAT_POS_VAR == 127)
    ...
    bool LDPCDecoder_OMS_SSE::decode_8bits(char Intrinsic_fix[], char Rprime_fix[], int nombre_iterations)
    {
        ////////////////////////////////////////////////////////////////////////////
        //
